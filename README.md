...
Example code visualising the ice mask in the [Google Earth Engine Code Editor](https://code.earthengine.google.com/):
...
// Center the map over Greenland
Map.setCenter(-42, 72, 4); // longitude, latitude, zoom level
